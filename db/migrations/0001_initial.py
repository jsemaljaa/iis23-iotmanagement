    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('invitation', 'Invitation'), ('system', 'System Notification'), ('access', 'Participation Request')], default='system', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.IntegerField()),
                ('operator', models.CharField(choices=[('>', 'is greater than'), ('>=', 'is greater or equal'), ('<', 'is less than'), ('<=', 'is less or equal'), ('=', 'is equal')], default='>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_requests', to='db.userprofile')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_requests', to='db.userprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('notification_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='db.notification')),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_invitations', to='db.userprofile')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_invitations', to='db.userprofile')),
                ('system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.system')),
            ],
            bases=('db.notification',),
        ),
