...
urlpatterns += [
    ...
    path('requests/accept/<int:notification_id>/', views.accept_request, name='accept_request'),
    path('requests/decline/<int:notification_id>/', views.decline_request, name='decline_request'),
    ...
    path('system/<int:system_id>/request-participation/', views.request_participation, name='request_participation'),
    ...
    path('devices/<int:device_id>/parameters', views.get_device_params, name='get_device_params'),
    path('systems/<int:system_id>/devices/<int:device_id>/add-parameters', views.add_params_to_system, name='add_params_to_system'),
